      ...
      <Layout>
        <section className="w-full bg-gradient-to-b from-gray-50 to-white py-8 md:py-16">
          ...
          >
            ...
            <motion.p
              className="text-gray-600 text-lg leading-relaxed max-w-3xl mt-4"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
      ...
      <Layout>
        <section className="w-full bg-gradient-to-b from-gray-50 to-white py-8 md:py-16">
          <div className="container mx-auto max-w-7xl px-4 md:px-6">
            ...
            {/* Empty state */}
            <motion.div
              className="flex flex-col items-center justify-center py-8 sm:py-12 md:py-16 lg:py-20 bg-white rounded-lg shadow-md"
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.3 }}
            >
              <Heart className="w-12 sm:w-16 md:w-20 h-12 sm:h-16 md:h-20 text-gray-300 mb-4" />
      ...
      <section className="w-full bg-gradient-to-b from-gray-50 to-white py-4 md:py-8 lg:py-16">
        <div className="container mx-auto max-w-7xl px-3 sm:px-4 md:px-6">
          ...
          >
            ...
            <motion.p
              className="text-gray-600 text-sm sm:text-base leading-relaxed max-w-3xl mt-4"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ delay: 0.2 }}
            >
