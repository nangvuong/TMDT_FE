...
const Setting: React.FC = () => {
      ...
      <Layout>
        <section className="w-full bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 py-8 md:py-16 min-h-screen">
          <div className="container mx-auto max-w-7xl px-4 md:px-6">
            <button
              onClick={() => navigate(-1)}
              className="inline-flex items-center gap-2 px-4 py-2 text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-all font-medium mb-8"
            >
              <ArrowLeft className="w-4 h-4" />
              Quay lại
            </button>
            <div className="text-center py-12">
              <p className="text-xl text-gray-600 dark:text-gray-400 mb-4">Vui lòng đăng nhập để truy cập cài đặt</p>
  ...
  return (
    <Layout>
      <section className="w-full bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 py-8 md:py-16 min-h-screen pb-20 md:pb-8">
        <div className="container mx-auto max-w-5xl px-4 md:px-6">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 dark:text-gray-100 mb-2 md:mb-3">
              Cài đặt
            </h1>
            <div className="flex items-center gap-2 text-gray-600 dark:text-gray-400">
              <div className="h-1 w-12 bg-gradient-to-r from-gray-900 dark:from-gray-100 to-transparent rounded-full" />
            ...
            <motion.div
              className={`mb-8 p-4 rounded-xl border-l-4 flex items-start gap-3 ${
                saveMessage.type === 'success'
                  ? 'bg-green-100 dark:bg-green-900/30 border-l-green-600 dark:border-l-green-500 text-green-800 dark:text-green-200'
                  : 'bg-red-100 dark:bg-red-900/30 border-l-red-600 dark:border-l-red-500 text-red-800 dark:text-red-200'
              }`}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            {/* Profile Section */}
            <motion.div
              className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm dark:shadow-gray-900/30 border border-gray-100 dark:border-gray-700 p-8 hover:shadow-md dark:hover:shadow-gray-900/50 transition-shadow"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Thông tin cá nhân</h2>
                  <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Cập nhật hồ sơ của bạn</p>
                </div>
              </div>
            ...
            >
              <div className="flex items-center gap-4 mb-8">
                <div className="p-3 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-600 rounded-xl">
                  <Lock size={28} className="text-gray-700 dark:text-gray-300" />
                </div>
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Bảo mật</h2>
                  <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Đổi mật khẩu của bạn</p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            >
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Thông báo</h2>
                  <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Quản lý thông báo của bạn</p>
                </div>
              </div>
            ...
            >
              <div className="flex items-center gap-4 mb-8">
                <div className="p-3 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-600 rounded-xl">
                  <Globe size={28} className="text-gray-700 dark:text-gray-300" />
                </div>
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Ngôn ngữ & Giao diện</h2>
                  <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Tùy chỉnh trải nghiệm</p>
                </div>
              </div>
              ...
              <div className="space-y-5">
                ...
                <div className="bg-gradient-to-r from-blue-100 to-blue-200 dark:from-blue-900/30 dark:to-blue-800/30 rounded-xl p-4 mt-6">
          ...
          >
            ...
            <div className="flex items-center gap-2 md:gap-4 mb-6 md:mb-8">
              <div className="p-2 md:p-3 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-600 rounded-xl">
                <MapPin size={24} className="md:w-7 md:h-7 text-gray-700 dark:text-gray-300" />
              </div>
              <div className="min-w-0 flex-1">
                <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100 truncate">Địa chỉ giao hàng</h2>
                <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400 mt-0.5 md:mt-1 truncate">Quản lý địa chỉ nhận hàng của bạn</p>
              </div>
            </div>

            {/* Address Section Container */}
            <motion.div
              className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm dark:shadow-gray-900/30 border border-gray-100 dark:border-gray-700 p-4 md:p-8 hover:shadow-md dark:hover:shadow-gray-900/50 transition-shadow"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              {addressLoading ? (
                <motion.div
                  ...
                  animate={{ opacity: 1 }}
                >
                  <div className="inline-flex items-center justify-center w-12 h-12 bg-gray-200 dark:bg-gray-700 rounded-full mb-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 font-medium">Đang tải địa chỉ...</p>
                </motion.div>
              ) : addresses.length === 0 ? (
                <motion.div
                  className="bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 rounded-xl p-6 md:p-12 text-center border border-gray-300 dark:border-gray-600"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                >
                  <MapPin size={40} className="md:w-12 md:h-12 text-gray-400 dark:text-gray-500 mx-auto mb-3 md:mb-4" />
                  <h3 className="text-base md:text-lg font-bold text-gray-900 dark:text-gray-100 mb-1 md:mb-2">Chưa có địa chỉ nào</h3>
                  <p className="text-xs md:text-sm text-gray-600 dark:text-gray-400 mb-4 md:mb-6">Thêm địa chỉ giao hàng đầu tiên của bạn</p>
                  <Button
                    onClick={() => openAddressModal()}
                  >
                    ...
                    {addresses.map((address, idx) => (
                      <motion.div
                        ...
                        className={`relative rounded-xl md:rounded-2xl shadow-sm border transition-all hover:shadow-md group ${
                          address.isDefault
                            ? 'bg-gradient-to-br from-gray-100 to-white dark:from-gray-800 dark:to-gray-900 border-gray-300 dark:border-gray-600'
                      ...
                      >
                        ...
                        <AnimatePresence>
                          {address.isDefault && (
                            <motion.div
                              className="absolute top-2 right-2 md:top-4 md:right-4 inline-flex items-center gap-1 px-2 md:px-3 py-0.5 md:py-1 bg-gray-300 dark:bg-gray-600 text-gray-800 dark:text-gray-200 rounded-full text-xs font-bold"
                        ...
                        <AnimatePresence>
                          {deleteConfirmId === address.id && (
                            <motion.div
                              className="absolute inset-0 bg-black/40 dark:bg-black/60 rounded-2xl flex items-center justify-center backdrop-blur-sm z-50"
                              initial={{ opacity: 0 }}
                              animate={{ opacity: 1 }}
                              exit={{ opacity: 0 }}
                            ...
                            >
                              <motion.div
                                className="bg-white dark:bg-gray-800 rounded-xl p-6 text-center max-w-xs"
