...
/**
 * Profile Page - User physical profile management with Layout wrapper
 */
const Profile: React.FC = () => {
  const navigate = useNavigate();
  usePageTitle('Profile | Fitness Mart');
  useScrollReset();
          ...
          >
            ...
            <motion.div className="space-y-4" variants={itemVariants}>
              ...
              <Select
                ...
                onChange={(value) => setFormData(prev => ({ ...prev, fitnessGoal: value as FitnessGoal }))}
                options={[
